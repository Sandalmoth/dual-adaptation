#ifndef LOGISTIC_DUAL_ADAPTATION_PROCESS_H__
#define LOGISTIC_DUAL_ADAPTATION_PROCESS_H__
...
// In the logistically balanced DAP the death rate
// is proportional to the square of the population size
// thus there exists a stable point where birth and death
// rates are equal. That becomes the average(-ish) population size
...
private:
  ...
  double interaction_death_rate = 0.0;
